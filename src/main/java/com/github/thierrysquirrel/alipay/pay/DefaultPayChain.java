...
import com.github.thierrysquirrel.alipay.container.PayParamConstant;
import com.github.thierrysquirrel.alipay.pay.close.param.PayCloseParamChain;
import com.github.thierrysquirrel.alipay.pay.download.param.PayDownloadQueryParamChain;
import com.github.thierrysquirrel.alipay.pay.param.AppPayParamChain;
import com.github.thierrysquirrel.alipay.pay.param.PagePayParamChain;
import com.github.thierrysquirrel.alipay.pay.param.WapPayParamChain;
import com.github.thierrysquirrel.alipay.pay.query.param.PayQueryParamChain;
import com.github.thierrysquirrel.alipay.pay.refund.param.PayRefundParamChain;
import com.github.thierrysquirrel.alipay.pay.refund.query.param.PayRefundQueryParamChain;
import lombok.Data;
...
public class DefaultPayChain {
     ...
     * {@linkplain com.alipay.api.domain.AlipayTradeAppPayModel AlipayTradeAppPayModel}
     * <p>
     * 自定义支付参数,建议使用
     * {@linkplain com.alipay.api.domain.AlipayTradeAppPayModel AlipayTradeAppPayModel}
     *
     ...
     * Recommended {@linkplain com.alipay.api.domain.AlipayTradeWapPayModel AlipayTradeWapPayModel}
     * <p>
     * 自定义支付参数,建议使用
     * {@linkplain com.alipay.api.domain.AlipayTradeWapPayModel AlipayTradeWapPayModel}
     *
    ...
    /**
     * Custom Payment Parameters,
     * Recommended {@linkplain com.alipay.api.domain.AlipayTradePagePayModel AlipayTradePagePayModel}
     * <p>
     * 自定义支付参数,建议使用
     * {@linkplain com.alipay.api.domain.AlipayTradePagePayModel AlipayTradePagePayModel}
     *
     * @param payModel payModel
     * @return PagePayParamChain
     */
     ...
     * Recommended {@linkplain com.alipay.api.domain.AlipayTradeCloseModel AlipayTradeCloseModel}
     * <p>
     * 自定义关闭交易,建议使用
     * {@linkplain com.alipay.api.domain.AlipayTradeCloseModel AlipayTradeCloseModel}
     *
     ...
     * Recommended {@linkplain com.alipay.api.domain.AlipayTradeQueryModel AlipayTradeQueryModel}
     * <p>
     * 自定义查询付款,建议使用
     * {@linkplain com.alipay.api.domain.AlipayTradeQueryModel AlipayTradeQueryModel}
     *
    ...
    /**
     * Custom Refund
     * Recommended {@linkplain com.alipay.api.domain.AlipayTradeRefundModel AlipayTradeRefundModel}
     * <p>
     * 自定义退款,建议使用
     * {@linkplain com.alipay.api.domain.AlipayTradeRefundModel AlipayTradeRefundModel}
     *
    ...
    /**
     * Custom Refund Query
     * Recommended {@linkplain com.alipay.api.domain.AlipayTradeFastpayRefundQueryModel AlipayTradeFastpayRefundQueryModel}
     * <p>
     * 自定义退款查询,建议使用
     * {@linkplain com.alipay.api.domain.AlipayTradeFastpayRefundQueryModel AlipayTradeFastpayRefundQueryModel}
     *
     * @param queryModel queryModel
     * @return PayRefundQueryParamChain
     */
    ...
    /**
     * Query Bill Download,Document Address https://docs.open.alipay.com/api_15/alipay.data.dataservice.bill.downloadurl.query
     * <p>
     ...
     * Recommended {@linkplain com.alipay.api.domain.AlipayDataDataserviceBillDownloadurlQueryModel AlipayDataDataserviceBillDownloadurlQueryModel}
     * <p>
     * 自定义查询账单下载,建议使用
     * {@linkplain com.alipay.api.domain.AlipayDataDataserviceBillDownloadurlQueryModel AlipayDataDataserviceBillDownloadurlQueryModel}
     *
     * @param queryModel queryModel
     * @return PayDownloadQueryParamChain
     */
